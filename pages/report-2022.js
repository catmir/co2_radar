    ...
    return (
        <>
          ...
          <main className="page-wrapper">
            <section id="report" className="bg-dark dark-mode position-relative pt-4 pb-5">
              <div className="container position-relative zindex-2 py-md-3 py-lg-4">
                <div className="row align-items-start pt-5 pb-2 pb-sm-3 mt-sm-4">
                  ...
                  <div className="row align-items-start pt-3 pb-2 pb-sm-3 mt-sm-4">
                    ...
                    <p className="col-6 text-light fs-5 fw-light">At the same time, CO<sub>2</sub> emissions unfortunately rose to familiar heights. Please find an excerpt of the 41 largest CO<sub>2</sub> emitters (in metric tons) in the table below, filterable by company name and country of origin.</p>
                  </div>
                </div>
              </div>
            </section>
